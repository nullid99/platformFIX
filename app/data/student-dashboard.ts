...
export type StreamKind = "Разбор" | "Стрим";
...
export type ScheduleEventKind = "Практическая часть" | "Q&A" | "Разбор ДЗ";
...
export const studentDashboard = {
  ...
  journal: [
    { id: "trade-1", symbol: "EUR", title: "Ложный пробой уровня", date: "Сегодня", result: 2.1, outcome: "WIN" },
    { id: "trade-2", symbol: "GBP", title: "Возврат в зону", date: "19 июля", result: 1.4, outcome: "WIN" },
    { id: "trade-3", symbol: "XAU", title: "Ранний вход", date: "18 июля", result: -0.8, outcome: "LOSS" },
  ] satisfies TradeEntry[],
  streams: [
    { id: "eur-zones", title: "Разбор зоны на EUR/USD", kind: "Разбор", module: "Модуль 03", date: "Сегодня", duration: "18:42", progress: 32, description: "Разбираем реакцию цены на зоне и последовательность подтверждений перед входом.", cover: "/fix-logo.jpg", isNew: true },
    { id: "live-practice", title: "Практика на живом рынке", kind: "Стрим", module: "Практическая часть", date: "21 июля", duration: "1:24:08", progress: 0, description: "Запись практической части с разбором сценариев и вопросов участников потока.", cover: null, isNew: false },
    { id: "two-trades", title: "Разбор двух сделок", kind: "Разбор", module: "Модуль 02", date: "19 июля", duration: "26:15", progress: 76, description: "Сравниваем план сделки с исполнением и отмечаем точку, где сценарий потерял силу.", cover: null, isNew: false },
    { id: "weekly-plan", title: "Как собрать торговый план", kind: "Разбор", module: "Модуль 04", date: "17 июля", duration: "31:04", progress: 0, description: "Пошагово собираем план наблюдения на неделю и условия отмены сценария.", cover: null, isNew: false },
  ] satisfies StreamItem[],
  events: [
    { id: "market-practice", day: "22", month: "ИЮЛ", weekday: "Завтра", type: "Практическая часть", title: "Разбор рынка в прямом эфире", time: "19:00 — 20:30", live: true, description: "Разберём текущие сценарии на EUR/USD и ответим на вопросы по разметке зон.", joined: true, recordingAvailable: false },
    { id: "curator-qa", day: "24", month: "ИЮЛ", weekday: "Четверг", type: "Q&A", title: "Q&A с куратором", time: "18:00 — 19:00", live: false, description: "Открытая встреча по вопросам модуля 03 и проверке домашних заданий.", joined: false, recordingAvailable: true },
    { id: "homework-review", day: "27", month: "ИЮЛ", weekday: "Воскресенье", type: "Разбор ДЗ", title: "Групповая проверка модуля 03", time: "17:00 — 18:30", live: false, description: "Разберём типичные ошибки в разметке и несколько работ участников потока.", joined: false, recordingAvailable: false },
